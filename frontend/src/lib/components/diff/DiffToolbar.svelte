...
<div class="diff-toolbar">
  <div class="toolbar-group">
    ...
    <div class="segmented-control">
      {#each tabOptions as opt}
        <button
          class="segment"
          class:segment--active={getTabWidth() === opt}
          onclick={() => setTabWidth(opt)}
        >
          {opt}
        </button>
      {/each}
  ...
  <div class="toolbar-group">
    ...
    <button
      class="toggle-switch"
      class:toggle-switch--on={getHideWhitespace()}
      role="switch"
      aria-checked={getHideWhitespace()}
      title={getHideWhitespace() ? "Show whitespace changes" : "Hide whitespace changes"}
      onclick={() => setHideWhitespace(!getHideWhitespace())}
    >
